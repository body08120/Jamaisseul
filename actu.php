...
<head>
    ...
    <meta name="keywords" content="association, précarité, vulnérabilité, isolement, Reims, entraide, solidarité, hébergement, asile, médico-social, logement adapté" />
    <meta name="description" content="Le site de l'association 'Jamais Seul à Reims'. Notre association s'engage à fournir des solutions concrètes pour aider les personnes en situation de précarité, de vulnérabilité ou d'isolement dans la ville de Reims. Découvrez nos activités et projets visant à créer un environnement d'entraide et de solidarité, ainsi que nos services d'hébergement, d'asile et de médico-social et logement adapté." />
    ...
    <div class="row">
      ...
      <div class="page-title-name">
          ...
          <ul class="page-breadcrumb">
            ...
            <li><a href="actu.php">Actualité</a> <i class="fa fa-angle-double-right"></i></li>
