   ...
   <div class="container">
      <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <p>Bienvenue sur le site de l'association "Jamais Seul à Reims". Notre association s'engage à fournir des solutions concrètes pour aider les personnes en situation de précarité, de vulnérabilité ou d'isolement dans la ville de Reims. Nous avons pour objectif de créer un environnement d'entraide et de solidarité pour aider ces personnes à surmonter leurs difficultés. </p>
            <p>Nous sommes présents sur trois pôles d'activités : l'hébergement, l'asile et le médico-social et logement adapté. Nous offrons ainsi une variété de services qui vont de l'hébergement temporaire et d'urgence à des solutions de logement adapté pour les personnes ayant des besoins médico-sociaux spécifiques.</p>
            <p>Notre site est conçu pour vous donner un aperçu de nos activités et de nos projets en cours. Nous espérons que vous trouverez ici toutes les informations nécessaires sur notre association. N'hésitez pas à nous contacter si vous avez des questions ou si vous souhaitez en savoir plus sur notre travail. Merci de votre visite et de votre soutien à notre cause.</p>
      ...
      <div class="row no-gutter">
              ...
              <div class="feature-step-2-box">
                 <div class="feature-step-2-title-left">
                  ...
                  <div class="feature-step-2-title-2-right">
                    <h3 class="text-white">PÔLE HÉBERGEMENT<br><br><br></h3>
                    <h4 class="text-white">Nous fournissons des solutions d'hébergement temporaire pour les personnes sans-abri et les personnes en situation de précarité.</h4>
                    </div>
                  </div>
                  </div>
            </div>
            ...
            <div class="col-lg-4 feature-step-2 bg-03 bg-overlay-black-50">
              <div class="clearfix">
                  ...
                  <div class="feature-step-2-title-2-right">
                    <h3 class="text-white">PÔLE ASILE</h3>
                    <h2 class="text-white">Modern website designers</h2>
                    <p class="text-white mt-20"> Working with Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla</p>
  ...
  <section class="page-section-ptb bg-overlay-black-60 parallax" style="background-image: url(img/03.jpg);">
   <div class="container">
    <div class="row">
        ...
        <div class="section-title text-center">
           <h6 class="text-white">Jamais Seul</h6>
           <h2 class="title-effect text-white"> En Chiffre</h2>
         </div>
         </div>
      </div>
     <div class="row position-relative">
       <div class="col-lg-3 col-md-6 sm-mb-30 text-center" >
        <div class="round-chart white" data-percent="4" data-color="#84ba3f" data-trackcolor="#ffffff"> <span class="percent"></span> </div>
         <h5 class="text-white">ÉTABLISSEMENTS</h5>
       </div>
       <div class="col-lg-3 col-md-6 sm-mb-30 text-center">
         <div class="round-chart white" data-percent="23" data-color="#84ba3f" data-trackcolor="#ffffff"> <span class="percent"></span> </div>
         <h5 class="text-white">SALARIÉS</h5>
       </div>
       <div class="col-lg-3 col-md-6 xs-mb-30 text-center">
         <div class="round-chart white" data-percent="153" data-color="#84ba3f" data-trackcolor="#ffffff"> <span class="percent"></span> </div>
         <h5 class="text-white">CAPACITÉ D'ACCUEIL</h5>
       </div>
       <div class="col-lg-3 col-md-6 text-center">
         <div class="round-chart white" data-percent="600000" data-color="#84ba3f" data-trackcolor="#ffffff"> <span class="percent"></span> </div>
