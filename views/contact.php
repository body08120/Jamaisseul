          ...
          <div class="col-lg-5">
            <div class="contact-3-info page-section-ptb">
              <div class="clearfix">
                ...
                <p class="mb-50">N'hésitez pas à nous contacter via le formulaire ci-dessous pour toute question ou
                  demande d'information <span class="tooltip-content" data-original-title="Mon-Fri 10am–7pm (GMT +1)"
                    data-bs-toggle="tooltip" data-placement="top"> 24 heures!</span></p>
                ...
                <form id="contactform" role="form" method="post" action="php/contact-form.php">
                  <div class="contact-form clearfix">
                    ...
                    <div class="g-recaptcha section-field clearfix"
                      data-sitekey="6LfNmS0UAAAAAO_ZVFQoQmkGPMlQXmKgVbizHFoq"></div>
                    <div class="section-field submit-button">
                      <input type="hidden" name="action" value="sendEmail" />
                      <button id="submit" name="submit" type="submit" value="Send" class="button"><span> Envoyer votre
                ...
                <div id="ajaxloader" style="display:none"><img class="mx-auto mt-30 mb-30 d-block"
                    src="assets/images/pre-loader/loader-02.svg" alt=""></div>
              </div>
            </div>
          </div>
        </div>
