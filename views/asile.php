                    ...
                    <div class="col-lg-12">
                        <div class="accordion shadow">
                            <div class="acd-group acd-active">
                                <a class="acd-heading" href="#">Centre d'accueil de demandeurs d'asile (CADA)</a>
                                <div class="acd-des">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-45 col-md-12">
                                            ...
                                            <ul class="list list-unstyled mb-30">
                                                <li><i class="fa fa-angle-right"></i> Orientation de l'OFII</li>
                                            </ul>
                            ...
                            <div class="acd-group">
                                <a class="acd-heading" href="#">Hébergement d’urgence pour demandeurs d’asile (HUDA)</a>
                                <div class="acd-des">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="acd-group">
                                <a class="acd-heading" href="#">Centre d’Accueil et d’Examen des Situations
                                    administratives (CAES)</a>
                                <div class="acd-des">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
